...
opt = {
   ...
   name = 'swap64_GAN_1W',              -- name of the experiment, should generally be passed on the command line
   ...
   checkpoints_dir = '/media/zsf/Software/Unet_swap/', -- models are saved here
...
function createRealFake()
    local mask_global =  create_gMask(pattern, mask_global, MAX_SIZE, opt)
    -- load real
